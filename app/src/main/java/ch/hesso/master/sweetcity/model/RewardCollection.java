 ...
 * transmitted over HTTP when working with the rewardService. For a detailed explanation see:
...
public final class RewardCollection extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<Reward> items;
   ...
   */
  public java.util.List<Reward> getItems() {
    return items;
  }
   ...
   */
  public RewardCollection setItems(java.util.List<Reward> items) {
    this.items = items;
    return this;
  }
