 ...
 * transmitted over HTTP when working with the accountService. For a detailed explanation see:
...
public final class AccountCollection extends com.google.api.client.json.GenericJson {
